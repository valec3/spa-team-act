...
\author{%
  ...
  \small E-mail: \texttt{\{vmaye, jmulluni, jedu, ccho\}@est.unap.edu.pe}
}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../../results/figures/lisa_mapa_NSE.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../../results/figures/lisa_mapa_pobreza.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\textwidth]{../../results/figures/moran_scatter_NSE.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\textwidth]{../../results/figures/moran_scatter_pobreza.png}
